...
export const Navbar: React.FC = () => {
  ...
  const navLinks = [
    ...
    { path: '/farming-techniques', label: 'Farming Techniques' },
    { path: '/government-schemes', label: 'Government Schemes' },
    { path: '/market-trends', label: 'Market Trends' },
    { path: '/agri-resources', label: 'Agri-Resources' },
            ...
            <div className="container mx-auto px-4 py-4 space-y-2">
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`block py-3 px-4 rounded-lg text-base font-medium transition-colors ${isActive(link.path)
